...
static void instr_execute_2op()
{
    ...
    if(opr_src.type==OPR_IMM&&opr_dest.data_size>opr_src.data_size){
       opr_src.val=alu_add(sign_ext(opr_src.val,opr_src.data_size),opr_dest.val,opr_dest.data_size);
    }
    else{
