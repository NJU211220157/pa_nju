...
instr_func opcode_entry[256] = {
    ...
    /* 0x18 - 0x1b*/ __ref___ref_sbb_r2rm_b, __ref_sbb_r2rm_v, __ref_sbb_rm2r_b, __ref_sbb_rm2r_v,
    /* 0x1c - 0x1f*/ __ref_sbb_i2a_b, __ref_sbb_r2rm_v, inv, inv,
...
instr_func group_1_b_entry[8] =
    {__ref_add_i2rm_b, or_i2rm_b, __ref_adc_i2rm_b, __ref_sbb_i2rm_b, __ref_and_i2rm_b, __ref_sub_i2rm_b, xor_i2rm_b, __ref_cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {__ref_add_i2rm_v, or_i2rm_v, __ref_adc_i2rm_v, __ref_sbb_i2rm_v, __ref_and_i2rm_v, __ref_sub_i2rm_v, xor_i2rm_v, __ref_cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {__ref_add_i2rm_bv, or_i2rm_bv, __ref_adc_i2rm_bv, __ref_sbb_i2rm_bv, __ref_and_i2rm_bv, __ref_sub_i2rm_bv, xor_i2rm_bv, __ref_cmp_i2rm_bv};
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, neg_rm_b, inv, inv, inv, inv};
