...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, inv, inv, inv, xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, or_i2rm_v, adc_i2rm_v, inv, inv, inv, xor_i2rm_v, cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, adc_i2rm_bv, inv, and_i2rm_bv, inv, xor_i2rm_bv, cmp_i2rm_bv};
