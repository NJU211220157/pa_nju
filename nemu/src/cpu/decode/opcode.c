...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ add_r2rm_b, __ref_add_r2rm_v, add_rm2r_b, add_rm2r_v,
    /* 0x04 - 0x07*/ add_i2a_b, __ref_add_i2a_v, inv, inv,
    ...
    /* 0x1c - 0x1f*/ sbb_i2a_b, sbb_r2rm_v, inv, inv,
    ...
    /* 0xa8 - 0xab*/ test_i2a_b, test_i2a_v, inv, inv,
...
instr_func group_1_v_entry[8] =
    {__ref_add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_i2rm_v, __ref_sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v};
...
instr_func group_3_b_entry[8] =
    {test_i2rm_b, inv, not_rm_b, inv, inv, inv, inv, inv};
...
instr_func group_5_indirect_entry[8] =
    {__ref_inc_rm_v, dec_rm_v, inv, inv, inv, inv, push_rm_v, inv};
