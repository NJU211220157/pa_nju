...
instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ inv, mov_i2rm_v, inv, inv,
    /* 0x04 - 0x07*/ mov_i2rm_v, mov_i2rm_v, inv, inv,
    ...
    /* 0x38 - 0x3b*/ cmp_rm2r_b, cmp_rm2r_v, cmp_r2rm_b, cmp_r2rm_v,
    ...
    /* 0x80 - 0x83*/ mov_i2rm_b, group_1_v, nemu_trap, cmp_i2a_v,
